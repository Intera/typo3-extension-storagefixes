...
$bootStorageFixes = function () {
    ...
    \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3\CMS\Extbase\SignalSlot\Dispatcher::class)
        ->connect(
            ...
            'recordPostRetrieval',
            /** @uses \Int\StorageFixes\Frontend\FileMetadataFreeTranslationAspect::languageAndWorkspaceOverlay() */
            \Int\StorageFixes\Frontend\FileMetadataFreeTranslationAspect::class,
